...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { costo: @procedure.costo, descripcion: @procedure.descripcion, nombre: @procedure.nombre }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { costo: @procedure.costo, descripcion: @procedure.descripcion, nombre: @procedure.nombre }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
